...
function CategoryPage() {
    ...
    function ProductSearch({ _id, category, name, pictures }) {
        return <ProductPrev _id={_id} category={category} name={name} pictures={pictures} />;
    }
    ...
    return (
        <div className="category-page-container">
            ...
            {productsSearch.length === 0 ? (
                <h1>Not product here. Please Search here...</h1>
            ) : (
                <Container>
                    <Row>
                        <Col md={{ span: 10, offset: 1 }}>
                            {productsSearch.map(product =><ProductPrev {...product}/>)}
